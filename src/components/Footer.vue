...
const column1Text =
    "We specialize in translating large-format texts and providing custom translation services.";
        ...
        <div class="col-lg-2 ml-auto">
          <div class="widget">
            ...
            <ul class="list-unstyled float-left links">
              ...
              <li><a href="#">Website Localization</a></li>
              <li><a href="#">Technical Text Translation</a></li>
        ...
        <div class="col-lg-2">
          <div class="widget">
            ...
            <ul class="list-unstyled float-left links">
              ...
              <li><a href="#">Literary Translation</a></li>
              <li><a href="#">Scientific Article Translation</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-3">
