...
const service1Quote =
    '"Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary resources."';
const personName = "James Anderson";
const designation = "Lead Product Manager at Facebook";

function youtubeVideoUrl() {
  return "https://www.youtube.com/watch?v=uvqDTbusdUU&t=37s";
}
</script>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4">
          ...
          <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
            <p>
              Far far away, behind the word mountains, far from the countries of Vokalia and Consonantia, live the blind texts. Separated they live in Bookmarksgrove right at the coast.
            </p>
