...
const items = [
  {
    ...
    des: "Develop and offer translation services that help your business reach new markets.",
  },
  {
    id: 2,
    name: "Product Creation",
    des: "Create innovative solutions and tools for translation automation and project management.",
  },
  {
    id: 3,
    name: "Success Every Day",
    des: "Ensure quality translation and support to keep your customers satisfied.",
  },
  {
    id: 4,
    name: "Bringing Ideas to Life",
    des: "Collaborate with us to develop personalized, custom translation projects.",
  },
];
const total = 4;
</script>
