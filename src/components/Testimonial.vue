...
const subHeading = "What our customers say about us";
const testimonials = [
  {
    name: "Jumaboev Shahsod",
    designation: "Customer",
    quote:
        '"Excellent service and quick execution! The translations were performed at the highest level, and all deadlines were met."',
    photo: "images/person_1.jpg",
  },
  {
    name: "Timur Rahimberdiev",
    designation: "Customer",
    quote:
        '"I am impressed with the quality of translation and the team’s professionalism. Highly recommend!"',
  ...
  },
  {
    ...
    designation: "Customer",
    quote:
        '"We worked on a large project, and the team proved to be true professionals. Everything was completed on time!"',
                ...
                <div class="text">
                  ...
                  <div class="author d-flex">
                    ...
                    <div>
                      ...
                      <span class="d-block">{{ testimonials[0].designation }}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="text">
                  ...
                  <div class="author d-flex">
                    ...
                    <div>
                      ...
                      <span class="d-block">{{ testimonials[1].designation }}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="text">
                  ...
                  <div class="author d-flex">
                    ...
                    <div>
                      ...
                      <span class="d-block">{{ testimonials[2].designation }}</span>
                    </div>
                  </div>
                </div>
              </div>
